...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void createJornadas(){
        ...
        try{
            ...
            jornada1.setName("Mañana");
            jornada1.setHorario("7-12");
            jornada2.setName("Tarde");
            jornada2.setHorario("12-19");
            jornada3.setName("Noche");
            jornada3.setHorario("19-0");

            values.put("NOMBRE",jornada1.getName());
            values.put("HORARIO",jornada1.getHorario());

            db.insert("JORNADA",null, values);

            values = new ContentValues();
            values.put("NOMBRE",jornada2.getName());
            values.put("HORARIO",jornada2.getHorario());

            db.insert("JORNADA",null, values);

            values = new ContentValues();
            values.put("NOMBRE",jornada3.getName());
            values.put("HORARIO",jornada3.getHorario());
